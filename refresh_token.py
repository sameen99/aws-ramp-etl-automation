...
# Load existing environment variables from custom env file
env_file_path = r"/home/sameen/qb_scripts/.env_access_ramp"
load_dotenv(dotenv_path=env_file_path)

# Ramp API endpoint and credentials
endpoint = "https://api.ramp.com/developer/v1/token"
client_id = "ramp_id_ASJSBtSasVyAhSrmk7swZvnXyvvX2wmLKTTcI5cP"
client_secret = "ramp_sec_R4JzErS3x2SpH1JJwiDD4Jp7rEOJBbVQJNPnMRt6VbQlrwzH"
